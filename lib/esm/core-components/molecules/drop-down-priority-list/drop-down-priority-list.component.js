                ...
                <View style={StyleSheet.flatten([
                  ...
                  <View style={StyleSheet.flatten([
                    ...
                    <View style={StyleSheet.flatten([
                      ...
                      <FlatList testID={testID + ' flatlist'} accessibilityLabel={accessibilityLabel + ' flatlist'} keyboardShouldPersistTaps="handled" contentContainerStyle={{ paddingBottom: 20 }} style={styles.flatListView} data={optionList} renderItem={({ item, index, }) => (<View key={index === null || index === void 0 ? void 0 : index.toString()}>
          ...
          <View>
            ...
            <View style={[styles.warperView, styles.optionView]}>
              <View style={{ flexDirection: 'row' }}>
                ...
                <Text style={styles.text}>{value === null || value === void 0 ? void 0 : value.title}</Text>
              </View>
