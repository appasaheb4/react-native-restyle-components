...
export const SectionListItem = ({ data = [], isStickySectionHeadersEnabled = true, onChange, }) => {
    ...
    const renderSection = (sectionItem, { list }) => {
        ...
        {(list === null || list === void 0 ? void 0 : list.length) > 0 ? (<FlatList data={list} numColumns={numColumns} style={{
                ...
                {(lastItem === null || lastItem === void 0 ? void 0 : lastItem.title) == (sectionItem === null || sectionItem === void 0 ? void 0 : sectionItem.title) ? null : (<View style={styles.bottomSeparateView}/>)}
    ...
    return (<View>
      <SectionList sections={section} renderItem={({ section, item }) => renderSection(section, item)} renderSectionHeader={({ section: { title } }) => (<Text style={[
            ...
            {title}
          </Text>)} stickySectionHeadersEnabled={isStickySectionHeadersEnabled} keyExtractor={item => `time-${item === null || item === void 0 ? void 0 : item.key}`}/>
    </View>);
};
