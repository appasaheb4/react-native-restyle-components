                ...
                <react_native_1.View style={react_native_1.StyleSheet.flatten([
                  ...
                  <react_native_1.View style={react_native_1.StyleSheet.flatten([
                    ...
                    <react_native_1.View style={react_native_1.StyleSheet.flatten([
                      ...
                      <react_native_1.FlatList testID={testID + ' flatlist'} accessibilityLabel={accessibilityLabel + ' flatlist'} keyboardShouldPersistTaps="handled" contentContainerStyle={{ paddingBottom: 20 }} style={styles.flatListView} data={optionList} renderItem={({ item, index, }) => (<react_native_1.View key={index === null || index === void 0 ? void 0 : index.toString()}>
