...
export const SearchDropDownList = ({ title = '', placeholder = 'Search Text', displayValue = '', list = [], displayKey = '', onSearch, onSelect, }) => {
    ...
    return (<View>
      ...
      {isOpen && (<View style={styles.flatListWarperView}>
          {optionList?.length > 0 ? (<FlatList style={styles.flatListView} data={optionList} nestedScrollEnabled contentContainerStyle={{ paddingBottom: 20 }} renderItem={({ item }) => (<View>
