...
exports.DropDownPriorityList = react_1.default.forwardRef(({ title = '', data = [], displayKey = '', displayValue = 'Select', testID, mode = 'default', maxHeight = 340, minHeight = 0, search = false, disable = false, dropdownPosition = 'auto', keyboardAvoiding = true, backgroundColor, containerStyle, accessibilityLabel, onChange, }, currentRef) => {
    var _a, _b;
    ...
    (0, react_1.useEffect)(() => {
        if (displayValue != 'Select')
            setValue({ color: value === null || value === void 0 ? void 0 : value.color, title: displayValue });
        else
                    ...
                    <react_native_1.View style={react_native_1.StyleSheet.flatten([
                      ...
                      {(optionList === null || optionList === void 0 ? void 0 : optionList.length) > 0 ? (<react_native_1.FlatList testID={testID + ' flatlist'} accessibilityLabel={accessibilityLabel + ' flatlist'} keyboardShouldPersistTaps="handled" contentContainerStyle={{ paddingBottom: 20 }} style={styles.flatListView} data={optionList} renderItem={({ item, index, }) => (<react_native_1.View key={index === null || index === void 0 ? void 0 : index.toString()}>
                              <react_native_1.TouchableOpacity style={{
                                ...
                                <react_native_1.Text style={[styles.text, { marginLeft: 4 }]}>
                                  {item[displayKey]}
                                </react_native_1.Text>
            ...
            disable && { backgroundColor: theme.colors.gray1 },
              ...
              <react_native_1.View style={{ flexDirection: 'row' }}>
                ...
                <react_native_1.Text numberOfLines={1} style={{ color: theme.colors.gray6 }}>
                  {((_a = value === null || value === void 0 ? void 0 : value.title) === null || _a === void 0 ? void 0 : _a.length) < 40
            ? `${value === null || value === void 0 ? void 0 : value.title}`
            : `${(_b = value === null || value === void 0 ? void 0 : value.title) === null || _b === void 0 ? void 0 : _b.substring(0, 40)}...`}
                </react_native_1.Text>
              </react_native_1.View>
...
//# sourceMappingURL=drop-down-priority-list.component.js.map