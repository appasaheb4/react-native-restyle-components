...
export const OtpVerify = ({ onVerify }) => {
    ...
    return (<>
			<View flexDirection="row" justifyContent="space-between" marginVertical="m" width={Dimensions.get('screen').width - 160}>
				{inputs.map((i, j) => (<TextInput key={j.toString()} style={{
                width: HIGHT,
                height: HIGHT,
