...
export const DropDownPriorityList = React.forwardRef(({ title = '', data = [], displayKey = '', displayValue = 'Select', testID, mode = 'default', maxHeight = 340, minHeight = 0, search = false, dropdownPosition = 'auto', keyboardAvoiding = true, backgroundColor, containerStyle, accessibilityLabel, onChange, }, currentRef) => {
                ...
                <View style={StyleSheet.flatten([
                  ...
                  <View style={StyleSheet.flatten([
                    ...
                    <View style={StyleSheet.flatten([
                      ...
                      {(optionList === null || optionList === void 0 ? void 0 : optionList.length) > 0 ? (<FlatList testID={testID + ' flatlist'} accessibilityLabel={accessibilityLabel + ' flatlist'} keyboardShouldPersistTaps="handled" contentContainerStyle={{ paddingBottom: 20 }} style={styles.flatListView} data={optionList} renderItem={({ item, index, }) => (<View key={index === null || index === void 0 ? void 0 : index.toString()}>
          ...
          <View>
            ...
            <View style={[styles.warperView, styles.optionView]}>
              <View style={{ flexDirection: 'row' }}>
                ...
                <Text numberOfLines={1}>{value === null || value === void 0 ? void 0 : value.title}</Text>
              </View>
