...
import { Box, TextRN } from '@/library/components';
    ...
    return (<Box flexDirection="row" alignItems="center" justifyContent="space-between" marginVertical="md">
      <LinearGradient style={{
        ...
        {content.map((item, index) => (<>
            <Box>
              <Box key={index} backgroundColor={index + 1 === active ? 'white' : 'transparent'} borderColor="white" borderWidth={1} height={stepperSize} width={stepperSize} borderRadius={stepperSize / 2}/>
