...
exports.DropDownCheckBoxParentChild = react_1.default.forwardRef(({ title = '', data = [], mode = 'default', maxHeight = 340, minHeight = 0, search = false, dropdownPosition = 'auto', keyboardAvoiding = true, backgroundColor, containerStyle, onChange, }, currentRef) => {
                      ...
                      <react_native_1.FlatList style={styles.flatListView} data={optionList} contentContainerStyle={{ paddingBottom: 20 }} renderItem={({ item, index, }) => {
                        ...
                        return (<react_native_1.View>
                            <react_native_1.TouchableOpacity style={{
                              ...
                              <react_native_1.Text style={{ marginLeft: 6 }}>
