...
exports.DropDownList = react_1.default.forwardRef(({ displayValue = 'Select', title = '', displayKey = 'title', testID, onChange, containerStyle, data = [], valueField, search = false, maxHeight = 340, minHeight = 0, disable = false, keyboardAvoiding = true, onFocus, onBlur, autoScroll = true, dropdownPosition = 'auto', backgroundColor, accessibilityLabel, mode = 'default', }, currentRef) => {
    ...
    const _renderDropdown = () => {
        return (<react_native_1.TouchableWithoutFeedback testID={testID} accessible={!!accessibilityLabel} accessibilityLabel={accessibilityLabel} onPress={showOrClose} disabled={disable}>
          <react_native_1.View>
            {!lodash_1.default.isEmpty(title) && <react_native_1.Text style={styles.header}>{title}</react_native_1.Text>}
            <react_native_1.View style={[
                styles.warperView,
                styles.optionView,
                disable && { backgroundColor: theme.colors.gray1 },
            ]}>
              <react_native_1.Text numberOfLines={1} style={{ color: theme.colors.gray6 }}>
                {(value === null || value === void 0 ? void 0 : value.length) < 46
                ? `${value}`
                : `${value === null || value === void 0 ? void 0 : value.substring(0, 46)}...`}
              </react_native_1.Text>
                ...
                <react_native_1.View style={react_native_1.StyleSheet.flatten([
                  ...
                  <react_native_1.View style={react_native_1.StyleSheet.flatten([
                    ...
                    <react_native_1.View style={react_native_1.StyleSheet.flatten([
                      ...
                      {(optionList === null || optionList === void 0 ? void 0 : optionList.length) > 0 ? (<react_native_1.FlatList testID={testID + ' flatlist'} accessibilityLabel={accessibilityLabel + ' flatlist'} keyboardShouldPersistTaps="handled" contentContainerStyle={{ paddingBottom: 20 }} style={styles.flatListView} data={optionList} renderItem={({ item, index, }) => (<react_native_1.View key={index === null || index === void 0 ? void 0 : index.toString()}>
                              <react_native_1.TouchableOpacity style={{
                                marginVertical: 8,
                            }} onPress={() => {
                                onSelect(item);
                            }}>
                                <react_native_1.Text style={[styles.text, { marginLeft: 2 }]}>
                                  {item[displayKey]}
                                </react_native_1.Text>
                              </react_native_1.TouchableOpacity>
                            </react_native_1.View>)} keyExtractor={(_item, index) => index.toString()}/>) : (<react_native_1.View>
