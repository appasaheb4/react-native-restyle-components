...
export const DropDownCheckBoxParentChild = React.forwardRef(({ title = '', data = [], mode = 'default', maxHeight = 340, minHeight = 0, search = false, dropdownPosition = 'auto', keyboardAvoiding = true, backgroundColor, containerStyle, onChange, }, currentRef) => {
