...
exports.DropDownPriorityList = react_1.default.forwardRef(({ title = '', data = [], displayKey = '', displayValue = 'Select', testID, mode = 'default', maxHeight = 340, minHeight = 0, search = false, dropdownPosition = 'auto', keyboardAvoiding = true, backgroundColor, containerStyle, accessibilityLabel, onChange, }, currentRef) => {
          ...
          <react_native_1.View>
            ...
            <react_native_1.View style={[styles.warperView, styles.optionView]}>
              <react_native_1.View style={{ flexDirection: 'row' }}>
                ...
                <react_native_1.Text numberOfLines={1}>{value === null || value === void 0 ? void 0 : value.title}</react_native_1.Text>
              </react_native_1.View>
