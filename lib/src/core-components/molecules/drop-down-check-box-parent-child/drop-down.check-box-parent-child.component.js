                ...
                <View style={StyleSheet.flatten([
                  ...
                  <View style={StyleSheet.flatten([
                    ...
                    <View style={StyleSheet.flatten([
                      ...
                      {optionList?.length > 0 ? (<FlatList style={styles.flatListView} data={optionList} contentContainerStyle={{ paddingBottom: 20 }} renderItem={({ item, index, }) => (<View>
        ...
        <TouchableWithoutFeedback onPress={showOrClose} disabled={disable}>
          <View>
            ...
            marginLeft: 8,
                ...
                {isOpen ? (disable ? (<ArrowTopGray4 />) : (<ArrowTopIcon />)) : disable ? (<ArrowBottomGray4 />) : (<ArrowBottomIcon />)}
              </View>
            </TouchableOpacity>
          </View>
        </TouchableWithoutFeedback>
