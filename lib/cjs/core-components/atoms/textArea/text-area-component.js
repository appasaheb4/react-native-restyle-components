...
const TextArea = ({ title = '', placeholder = '', onChangeText, }) => {
    ...
    return (<react_native_1.View>
      ...
      <react_native_1.View style={styles.textAreaContainer}>
        <react_native_1.TextInput value={value} placeholder={placeholder} style={styles.textArea} underlineColorAndroid="transparent" placeholderTextColor="grey" numberOfLines={10} multiline={true} onChangeText={(value) => {
            onChangeText(value);
            setValue(value);
        }}/>
      </react_native_1.View>
