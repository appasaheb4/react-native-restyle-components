...
exports.DropDownCheckBoxParentChild = react_1.default.forwardRef(({ title = '', displayValue = 'Select', disable = false, data = [], mode = 'default', maxHeight = 340, minHeight = 0, search = false, dropdownPosition = 'auto', keyboardAvoiding = true, backgroundColor, containerStyle, onChange, }, currentRef) => {
                ...
                <react_native_1.View style={react_native_1.StyleSheet.flatten([
                  ...
                  <react_native_1.View style={react_native_1.StyleSheet.flatten([
                    ...
                    <react_native_1.View style={react_native_1.StyleSheet.flatten([
                      ...
                      {(optionList === null || optionList === void 0 ? void 0 : optionList.length) > 0 ? (<react_native_1.FlatList style={styles.flatListView} data={optionList} contentContainerStyle={{ paddingBottom: 20 }} renderItem={({ item, index, }) => {
                            var _a;
                            return (<react_native_1.View>
                              ...
                              {(_a = item[0][Object.keys(item[0])[0]]) === null || _a === void 0 ? void 0 : _a.map((e, i) => (<react_native_1.TouchableOpacity style={{
                                    ...
                                    <react_native_1.View style={[
                                        styles.radioCycle,
                                        {
                                            backgroundColor: (e === null || e === void 0 ? void 0 : e.title) == value
                                                ? theme.colors.primary
                                                : 'transparent',
                                            borderWidth: (e === null || e === void 0 ? void 0 : e.selected) ? 0 : 1,
                                        },
                                    ]}/>
                                    <react_native_1.Text style={[styles.text, { marginLeft: 6 }]}>
                                      {e.title}
                                    </react_native_1.Text>
                                  </react_native_1.TouchableOpacity>))}
                            </react_native_1.View>);
                        }} keyExtractor={(item, index) => index.toString()}/>) : (<react_native_1.View>
                          <react_native_1.Text style={{
                            textAlign: 'center',
                            fontWeight: 'bold',
                            margin: 40,
    ...
    return (<react_native_1.View ref={ref} onLayout={_measure}>
        <react_native_1.TouchableWithoutFeedback onPress={showOrClose} disabled={disable}>
          <react_native_1.View>
            {!lodash_1.default.isEmpty(title) && <react_native_1.Text style={styles.header}>{title}</react_native_1.Text>}
            <react_native_1.TouchableOpacity disabled={disable} style={styles.warperView} onPress={() => {
            setIsOpen(!isOpen);
        }}>
