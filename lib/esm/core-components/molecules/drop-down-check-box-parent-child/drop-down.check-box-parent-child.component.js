                ...
                <View style={StyleSheet.flatten([
                  ...
                  <View style={StyleSheet.flatten([
                    ...
                    <View style={StyleSheet.flatten([
                      ...
                      {(optionList === null || optionList === void 0 ? void 0 : optionList.length) > 0 ? (<FlatList style={styles.flatListView} data={optionList} contentContainerStyle={{ paddingBottom: 20 }} renderItem={({ item, index, }) => {
                            var _a;
                            return (<View>
